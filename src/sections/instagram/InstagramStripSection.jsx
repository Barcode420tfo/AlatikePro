...
import instagram01 from '../../../media/optimized/photos/IMG_1911.jpg'
import instagram02 from '../../../media/optimized/photos/IMG_7209.jpg'
import instagram03 from '../../../media/optimized/photos/everyday-shot-01.jpg'
import instagram04 from '../../../media/optimized/photos/instagram-bridal-orange-2026-04-22.jpg'
...
export function InstagramStripSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="instagram-shell deferred-section relative overflow-hidden bg-[#fbf7f2] px-7 pb-20 pt-18 text-[#2f2118] sm:px-9 lg:px-14 lg:pb-24 lg:pt-20"
    >
