...
import aboutPhoto from '../../../media/optimized/photos/about-ceo-adeola-v4.jpg'
...
export function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="about-shell deferred-section relative px-6 pb-18 pt-18 sm:px-8 lg:px-12 lg:pb-28 lg:pt-24"
    >
      ...
      <div className="mx-auto grid max-w-[1240px] items-center gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-14">
        <div className={`about-photo-wrap ${isVisible ? 'is-visible' : ''}`}>
          <div className="about-photo-frame">
            <img
              src={aboutPhoto}
              alt="Alatike, founder of Alatike Pro"
